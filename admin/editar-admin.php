...
if (!filter_var($id, FILTER_VALIDATE_INT)) {/* Valida que si no es una Entero entre al Error */
  die("Error!");
}
            ...
            <form role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelo-admin.php">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nivel" name="nivel" placeholder="Nivel: 0 o 1" value="<?php echo $admin['nivel']; ?>">
                </div>
                <div class="form-group">
